...
- [x] Обновление всех `sqlite3.connect` на новую абстракцию (завершено)
- [x] Обновление всех `aiosqlite.connect` на новую абстракцию (завершено)
- [x] Обновлены все файлы в `bot/tgbot/` (handlers, services, misc, fast_app)
- [x] Обновлен `api/main.py` для использования DatabaseConnection
- [x] Удалены все прямые импорты `sqlite3` и `aiosqlite`
